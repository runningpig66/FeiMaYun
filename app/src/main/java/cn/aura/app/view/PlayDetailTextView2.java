 ...
 * 为录播listview2使用
 */
public class PlayDetailTextView2 extends android.support.v7.widget.AppCompatTextView {

    public PlayDetailTextView2(Context context) {
        super(context);
    }

    public PlayDetailTextView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PlayDetailTextView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private float getMaxLineHeight(String str) {
        ...
        int line = (int) Math.ceil((this.getPaint().measureText(str) / (screenW - paddingLeft - paddingReft - 220)));
